...
"""
from ddm.losses.diversity import (content_diversity_loss, icd_k_for_ipc,
                                  intra_class_diversity_loss,
                                  intra_class_diversity_loss_kl, style_diversity_loss)
...
__all__ = ['calc_mean_std', 'gram_matrix', 'style_vector', 'moments_matching_loss',
           'correlation_matching_loss', 'icd_k_for_ipc', 'style_diversity_loss',
           'content_diversity_loss', 'intra_class_diversity_loss',
           'intra_class_diversity_loss_kl']
